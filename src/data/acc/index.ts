...
export const acc: GameData = {
  meta: {
    ...
    status: "released",
    setupFileNote: {
      es: "ACC guarda los setups como archivos .json en Documentos/Assetto Corsa Competizione/Setups/<auto>/<pista>. Podés copiar el setup ahí para importarlo en el juego.",
