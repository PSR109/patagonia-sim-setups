...
export const drivingTips: Record<Symptom, LocalizedText> = {
  understeer_entry: {
    es: "El frente no gira al entrar. Frená un toque antes y soltá el freno de forma PROGRESIVA mientras girás (trail-braking): eso carga el eje delantero y le da mordida. No metas toda la dirección de golpe.",
  ...
  understeer_mid: {
    es: "Subviraje en el medio: estás pidiendo más agarre del que hay. Bajá la velocidad de entrada, esperá a pasar el ápex y abrí la dirección recién cuando el auto empieza a rotar. Mirá más adelante, no a la trompa.",
  ...
  understeer_exit: {
    es: "Subviraje a la salida: abriste el acelerador muy temprano o muy brusco. Esperá a tener el auto más derecho y dosificá el gas de forma progresiva.",
  ...
  oversteer_entry: {
    es: "La cola se suelta al entrar: estás frenando muy tarde o soltando el freno de golpe con el auto girando. Liberá el freno más suave y evitá frenar fuerte mientras ya estás doblando.",
  ...
  oversteer_mid: {
    es: "Sobreviraje a media curva (lift-off): soltaste el acelerador de golpe y la carga se fue al frente. Mantené un hilo de gas estable en el medio; no levantes brusco.",
  ...
  oversteer_exit: {
    es: "La cola patina a la salida: demasiado acelerador con el auto todavía girando. Aplicá el gas progresivo y esperá a enderezar; ojo con el golpe de turbo/torque.",
  ...
  braking_instability: {
    es: "Inestable al frenar: frená en línea recta ANTES de girar y soltá progresivo. No mezcles freno fuerte con dirección. Si sigue, llevá un poco el reparto de frenos hacia adelante.",
  ...
  poor_traction: {
    es: "Patina al acelerar: gas más progresivo a la salida y esperá a que el auto se enderece antes del full throttle. Si patina en 1.ª/2.ª, una marcha más larga ayuda.",
  ...
  tyres_overheat: {
    es: "Gomas recalentadas: casi siempre es sobreconducción — demasiado deslizamiento y correcciones. Manejá más limpio y suave, deslizá menos. En carrera, gestioná el stint y no abuses temprano.",
  ...
  tyres_cold: {
    es: "Gomas frías sin temperatura: en el out-lap hacé zigzag y frená fuerte para meter calor; en clasi, una vuelta de preparación. No ataques con la goma fría.",
  ...
  bouncing: {
    es: "Rebote/porpoising en recta: es aerodinámico/altura, no de manejo (lo arregla el setup: más altura o más rigidez). Mientras tanto, evitá pianos a alta velocidad.",
  ...
  kerb_instability: {
    es: "Inestable en los pianos: usá menos piano y tomalo más plano, con el auto ya estable. No cargues pianos en plena transición de peso.",
...
export function trackPlaybook(track?: Track): CoachTip[] {
  ...
  if (track.kind === "stage") {
    ...
    const bySurface: Record<string, CoachTip> = {
      gravel: {
        ...
        body: {
          es: "La línea más limpia NO es la más rápida. Usá el peralte, dejá que el auto se mueva y deslice un poco, y anticipá con las notas. Freno de mano en las horquillas cerradas.",
      ...
      snow: {
        ...
        body: {
          es: "Suavidad extrema: todo anticipado y progresivo, nada brusco. Con clavos la goma muerde más de lo que parece — confiá, pero sin movimientos secos.",
      ...
      tarmac: {
        ...
        body: {
          es: "Manejalo como circuito: preciso, frenadas más tardías y usá todo el ancho del camino. Hay más agarre que en grava, así que podés ser más agresivo con la dirección.",
      ...
      mixed: {
        ...
        body: {
          es: "El agarre cambia dentro del tramo. Dejá margen, leé la superficie y adaptá: lo que funciona en lo seco te tira en el parche de hielo o tierra.",
  ...
  const byProfile: Record<string, CoachTip> = {
    "high-speed": {
      ...
      body: {
        es: "Acá el tiempo se gana con COMPROMISO en las curvas rápidas: cuanto más confiás, más rápido. Mínima corrección de dirección, entradas suaves, dejá que el aero trabaje. Medio segundo de duda en una rápida cuesta más que cualquier lenta.",
    ...
    "low-speed": {
      ...
      body: {
        es: "El tiempo está en TRACCIÓN y ROTACIÓN: frená fuerte y derecho, rotá el auto en el punto de giro y abrí el gas progresivo y temprano sin patinar. Las salidas de las lentas definen la vuelta.",
    ...
    mixed: {
      ...
      body: {
        es: "Premia la CONSISTENCIA: no sobreconduzcas las lentas justo después de una rápida. Adaptá el ritmo sector a sector y buscá fluir, no atacar cada curva al máximo.",
  ...
  if (track.lengthKm && track.lengthKm >= 7) {
    tips.push({
      ...
      body: {
        es: "Trazado largo: dividilo en sectores mentales y memorizá una referencia por curva. Un error temprano te cuesta toda la vuelta — prioridad a la limpieza sobre el ataque.",
...
export const practicePlan: CoachTip[] = [
  {
    ...
    body: {
      es: "Hacé 8–10 vueltas dentro de 0.5 s entre sí ANTES de buscar el límite. El tiempo sale de repetir bien, no de una vuelta mágica que no podés copiar.",
  ...
  },
  {
    ...
    body: {
      es: "Elegí tu PEOR sector y trabajá solo ese. Mejorar todo a la vez no funciona: aislá una zona, encontrá la referencia y recién pasá a la siguiente.",
  ...
  {
    title: { es: "3 · Cazá la frenada", en: "3 · Hunt the braking point" },
    body: {
      es: "La mayor parte del tiempo se pierde frenando de más o muy temprano. Probá frenar 5 m más tarde cada vuelta hasta pasarte de largo; después retrocedé un toque: ahí está tu punto.",
